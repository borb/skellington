#!/bin/bash
#
# obtained from https://raw.githubusercontent.com/odedlaz/tmux-onedark-theme/master/tmux-onedark-theme.tmux
# slightly modified by nine
#
...
set "status-right" "#[fg=$onedark_white,bg=$onedark_black,nounderscore,noitalics] #T  ${status_widgets} #[fg=$onedark_visual_grey,bg=$onedark_black]#[fg=$onedark_visual_grey,bg=$onedark_visual_grey]#[fg=$onedark_white, bg=$onedark_visual_grey]${date_format} #[fg=$onedark_green,bg=$onedark_visual_grey,nobold,nounderscore,noitalics]#[fg=$onedark_black,bg=$onedark_green,bold] ${time_format} #[fg=$onedark_yellow, bg=$onedark_green]#[fg=$onedark_red,bg=$onedark_yellow]"
set "status-left" "#[fg=$onedark_visual_grey,bg=$onedark_green,bold] #h:#S #{prefix_highlight}#[fg=$onedark_green,bg=$onedark_black,nobold,nounderscore,noitalics]"
